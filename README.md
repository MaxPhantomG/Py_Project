...
Также есть два пункта меню: File и Edit. File содержит команды:
...
* Find(ctrl+f) - найти информацию в тексте
* Replace(ctrl+r) - заменить последовательность символов на другую
